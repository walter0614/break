	   ...
	   <div class="container">
		...
		<form class="form-horizontal" action="../php/result2.php" method="POST">
		  	...
		  	<div class="form-group">
		    		...
		    		<label><input type="radio" class="checkbox-inline" name="tipoUsuario1" value="usuario">Usuario</label>
		    		<label><input type="radio" class="checkbox-inline" name="tipoUsuario2" value="proveedor">Proovedor</label>
		  	</div>
		  	<div class="form-group">
