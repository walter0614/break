	   ...
	   <div class="container">
		...
		<form class="form-horizontal" action="../php/result2.php" method="POST">
		  	...
		  	<div class="form-group">
		    		...
		    		<label><input type="checkbox" class="checkbox-inline" name="tipoUsuario1" value="">Usuario</label>
		    		<label><input type="checkbox" class="checkbox-inline" name="tipoUsuario2" value="">Proovedor</label>
		  	</div>
		  	<div class="form-group">
